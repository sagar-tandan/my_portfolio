import sagarpng from "../../assets/sagarpng.png";
const projects = [
  {
    id: 0,
    title: "Youtube Comments Analyzer",
    desc: "The youtube comment analyzer is a web app that uses YT api and machine learning model to predict emotions (5 classes) of youtube comments. It also provides insights into the overall.",
    category: "Machine Learning, Web Development",
    image:
      "https://firebasestorage.googleapis.com/v0/b/images-bf03f.appspot.com/o/Uploads%2Fyt.png?alt=media&token=6864e4ae-d9e1-4e5f-9c42-616b950e0f06",
  ...
  },
  {
    id: 4,
    title: "FlickVerse",
    desc: "The FlickVerse is an online streaming platform for movies and Tv Shows. TMDB API has been used to fetch the movies and TV shows details. This project is made only for the educational purpose.",
    ...
    link: "https://flickverse.netlify.app/",
    github: "https://github.com/sagar-tandan/FlickVerse",
  },

  {
    id: 1,
    title: "Veshraj Portfolio",
    desc: "This is my first web app which is dynamic personal Portfolio, made using ReactJs and Firebase.This allows users to have a look about the personal details, photos, projects, blogs and all. The admin can make any changes through this web app in realtime.",
    category: "Web Development",
    image:
  ...
  },
  {
    id: 2,
    title: "Project K",
    desc: "Project K is an android app that allows an admin to create a class (ID) and post routines, notes, and all other digital stuffs and allows other users (students) who joins class (ID) to access them.",
