...
const HamburgerIcon = () => {
  ...
  return (
    <div>
      ...
      <ul
        className={`absolute p-5 flex flex-col gap-6 w-[80%] md:w-[30%] h-[100vh] top-0 items-center font-SagarFont font-semibold text-xl text-black bg-white right-0 ${
      ...
      >
        <Link to="/">
          <li
            className={`pt-10 uppercase hover:text-[#29a587]  ${
              activeMenuItem === "home" ? "text-[#29a587]" : "text-black"
            }`}
            onClick={() => {
        ...
        <a href="#skills">
          <li
            className={`hover:text-[#29a587] uppercase ${
              activeMenuItem === "Skills" ? "text-[#29a587]" : "text-black"
            }`}
            onClick={() => {
        ...
        <a href="#contact">
          <li
            className={`hover:text-[#29a587] uppercase ${
              activeMenuItem === "contact" ? "text-[#29a587]" : "text-black"
            }`}
            onClick={() => {
