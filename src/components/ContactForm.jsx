...
import SlideUpComponent from "./SlideUpComponent.jsx";
    ...
    <div className="flex flex-col w-full my-12 lg:mr-16 ">
      <form onSubmit={handleSubmit} action="">
          ...
          <div className="flex flex-col gap-2 w-full ">
            <SlideUpComponent>
              <div>
                ...
                <span className="font-SagarFont font-bold text-[#29a587]">
                  {" "}
                  *
                </span>
              </div>
        ...
        <div className="w-full flex justify-end items-center my-3">
          <div className="group relative w-[70%] md:w-1/2 flex justify-center items-center">
            <button
              type="submit"
